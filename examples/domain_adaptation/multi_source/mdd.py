...
def main(args: argparse.Namespace):
    ...
    train_source_dataset = ConcatDataset([
        dataset(root=args.root, task=source, download=True, transform=train_transform)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='MDD for Multi-source Domain Adaptation')
    # dataset parameters
