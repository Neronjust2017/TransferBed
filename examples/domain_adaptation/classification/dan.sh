...
# Office31
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/office31 -d Office31 -s D -t A -a resnet50 --epochs 20 --seed 0 --log logs/dan/Office31_D2A
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/office31 -d Office31 -s W -t A -a resnet50 --epochs 20 --seed 0 --log logs/dan/Office31_W2A
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/office31 -d Office31 -s A -t W -a resnet50 --epochs 20 --seed 0 --log logs/dan/Office31_A2W
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/office31 -d Office31 -s A -t D -a resnet50 --epochs 20 --seed 0 --log logs/dan/Office31_A2D
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/office31 -d Office31 -s D -t W -a resnet50 --epochs 20 --seed 0 --log logs/dan/Office31_D2W
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/office31 -d Office31 -s W -t D -a resnet50 --epochs 20 --seed 0 --log logs/dan/Office31_W2D

# PACS
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ar -t Ca -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ar2Ca
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ar -t Ph -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ar2Ph
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ar -t Sk -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ar2Sk
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ca -t Ar -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ca2Ar
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ca -t Ph -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ca2Ph
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ca -t Sk -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ca2Sk
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ph -t Ar -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ph2Ar
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ph -t Ca -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ph2Ca
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Ph -t Sk -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Ph2Sk
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Sk -t Ar -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Sk2Ar
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Sk -t Ca -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Sk2Ca
CUDA_VISIBLE_DEVICES=0 python dan.py /data/weiyuhua/TransferBed/data/pacs -d PACS -s Sk -t Ph -a resnet18 --epochs 20 --seed 0 --log logs/dan/PACS_Sk2Ph
